 ...
 <section class="target container">
            ...
            <div class="target__cards"> <!--btn pro-->
                <div class="target__cards__pro">
                    <img class="target__cards__img" src="<?php bloginfo('template_directory');?>/assets/img/professionnels.jpg" alt="professionnels">
                    <a href="http://localhost/medigarde/professionnels-de-la-sante/"><div class="target__cards__filter"></div></a>
                    <a class="cards__a cat1" href="http://localhost/medigarde/professionnels-de-la-sante/">Professionnel de la santé</a>
                </div>
                <div class="target__cards__spe"> <!--btn pro spé-->
                    ...
                    <a href="http://localhost/medigarde/professions-specialises/"><div class="target__cards__filter"></div></a>
                    <a class="cards__a cat2" href="http://localhost/medigarde/professions-specialises/">Professionnel specialiste</a>
                </div>
                <div class="target__cards__ets"> <!--btn etablissement-->
                    ...
                    <a href="http://localhost/medigarde/etablissements-de-sante/"><div class="target__cards__filter"></div></a>
                    <a class="cards__a cat3" href="http://localhost/medigarde/etablissements-de-sante/">Etablissement medical paramedical medico social</a>
                </div>
            </div>
        ...
        <section class="container services" id="services">
            ...
            <div class="services__card">
                <div class="services__card__img">
                    <img class="card__img__placement" src="<?php bloginfo('template_directory');?>/assets/img/entretien.jpg" alt="placement pro">
                </div>
        ...
        <section class="container team">
            ...
            <div class="team__container">
                <div class="team__container">
                    <img class="team__img" src="<?php bloginfo('template_directory');?>/assets/img/equipe.jpg" alt="equipe Médigarde">
