                            ...
                            foreach ($fields as $field => $val) {
                                if ('jobfeature_' == substr($field, 0, 11)) {
                                    ...
                                    if ($job_post_layout_version == 'v2') {
                                        ...
                                        echo '<input type="text" id="icon_' . esc_attr($field) . '" class="sjb-job-feature-icon" name="icon_' . esc_attr($field) . '[icon]" value="' . esc_attr($icon_value['icon']) . '" placeholder="fa-briefcase" /><span class="input-group-addon"><i class="fa ' . esc_attr($icon_value['icon']) . '"></i></span> ';
                                    }
                ...
                <div class="sjb-content-featured">
                    ...
                    if ($job_post_layout_version == 'v2') {
                        ...
                        <div class="sjb-form-group" id="add-job_features">
                            ...
                            <input type="text" id="settings_job_feature_icon" class="sjb-job-feature-icon" placeholder="fa-briefcase" value="fa-briefcase" />
